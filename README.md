...
Autocomplete is now automated for anything that adds a function, all you have to do is add a wiki file in data/yourmodid/cide/wiki ending with a .md  - you dont have to add a json file, but you can still add them if you wish.
